...
exports.When_I_clear_cookies = When_I_clear_cookies;
exports.When_I_clear_all_cookies = When_I_clear_all_cookies;
 ...
 */
function When_I_clear_cookies(options) {
    cy.clearCookies((0, utils_1.getOptions)(options));
}
(0, cypress_cucumber_preprocessor_1.When)('I clear cookies', When_I_clear_cookies);
/**
 ...
 */
function When_I_clear_all_cookies(options) {
    cy.clearAllCookies((0, utils_1.getOptions)(options));
}
(0, cypress_cucumber_preprocessor_1.When)('I clear all cookies', When_I_clear_all_cookies);
