 ...
 */
function When_I_go(direction) {
    cy.go(direction);
}
(0, cypress_cucumber_preprocessor_1.When)('I go {int}', When_I_go);
/**
 * When I go back:
 *
 * ```gherkin
 ...
 * - {@link When_I_go_forward | When I go forward}
 */
function When_I_go_back() {
    cy.go('back');
}
(0, cypress_cucumber_preprocessor_1.When)('I go back', When_I_go_back);
/**
 * When I go forward:
 *
 * ```gherkin
 ...
 * - {@link When_I_go_back | When I go back}
 */
function When_I_go_forward() {
    cy.go('forward');
}
(0, cypress_cucumber_preprocessor_1.When)('I go forward', When_I_go_forward);
