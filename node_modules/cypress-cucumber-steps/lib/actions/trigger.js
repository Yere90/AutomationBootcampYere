 ...
 */
function When_I_trigger_event(eventName) {
    (0, utils_1.getCypressElement)().trigger(eventName);
}
(0, cypress_cucumber_preprocessor_1.When)('I trigger event {string}', When_I_trigger_event);
