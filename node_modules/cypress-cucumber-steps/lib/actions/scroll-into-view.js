 ...
 */
function When_I_scroll_into_view(options) {
    (0, utils_1.getCypressElement)().scrollIntoView((0, utils_1.getOptions)(options));
}
(0, cypress_cucumber_preprocessor_1.When)('I scroll into view', When_I_scroll_into_view);
