...
exports.When_I_visit_URL = When_I_visit_URL;
 ...
 * ```
 */
function When_I_visit_URL(url, options) {
    cy.visit(url, (0, utils_1.getOptions)(options));
}
(0, cypress_cucumber_preprocessor_1.When)('I visit {string}', When_I_visit_URL);
