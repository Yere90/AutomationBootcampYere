...
exports.When_I_set_viewport = When_I_set_viewport;
exports.When_I_set_viewport_width_height = When_I_set_viewport_width_height;
 ...
 */
function When_I_set_viewport(preset, orientation) {
    if (orientation === void 0) { orientation = 'portrait'; }
    cy.viewport(preset, orientation);
}
(0, cypress_cucumber_preprocessor_1.When)('I set viewport to {string}', When_I_set_viewport);
(0, cypress_cucumber_preprocessor_1.When)('I set viewport to {string} and {string}', When_I_set_viewport);
/**
 ...
 */
function When_I_set_viewport_width_height(width, height) {
    cy.viewport(width, height);
}
(0, cypress_cucumber_preprocessor_1.When)('I set viewport to {int}px by {int}px', When_I_set_viewport_width_height);
