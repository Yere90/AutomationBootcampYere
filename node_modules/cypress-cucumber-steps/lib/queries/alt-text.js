...
exports.When_I_find_elements_by_alt_text = When_I_find_elements_by_alt_text;
 ...
 */
function When_I_find_elements_by_alt_text(altText) {
    (0, utils_1.setCypressElement)(cy.get("[alt=".concat(JSON.stringify(altText), "]:visible")));
}
(0, cypress_cucumber_preprocessor_1.When)('I find elements by alt text {string}', When_I_find_elements_by_alt_text);
/**
 ...
 */
function When_I_find_element_by_alt_text(altText) {
    When_I_find_elements_by_alt_text(altText);
    (0, utils_1.setCypressElement)((0, utils_1.getCypressElement)().first());
}
(0, cypress_cucumber_preprocessor_1.When)('I find element by alt text {string}', When_I_find_element_by_alt_text);
/**
 ...
 * - {@link When_I_find_image_by_alt_text | When I find image by alt text}
 */
function When_I_find_images_by_alt_text(altText) {
    When_I_find_elements_by_alt_text(altText);
    (0, utils_1.setCypressElement)((0, utils_1.getCypressElement)().filter('img'));
}
(0, cypress_cucumber_preprocessor_1.When)('I find images by alt text {string}', When_I_find_images_by_alt_text);
/**
 ...
 * - {@link When_I_find_images_by_alt_text | When I find images by alt text}
 */
function When_I_find_image_by_alt_text(altText) {
    When_I_find_images_by_alt_text(altText);
    (0, utils_1.setCypressElement)((0, utils_1.getCypressElement)().first());
}
(0, cypress_cucumber_preprocessor_1.When)('I find image by alt text {string}', When_I_find_image_by_alt_text);
