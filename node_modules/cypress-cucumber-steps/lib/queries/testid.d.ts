 ...
 */
export declare function When_I_find_elements_by_testid(testId: string, options?: DataTable): void;
/**
 ...
 */
export declare function When_I_find_element_by_testid(testId: string, options?: DataTable): void;
