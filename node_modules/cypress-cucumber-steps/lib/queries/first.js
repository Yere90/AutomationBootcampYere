 ...
 */
function When_I_get_first_element(options) {
    (0, utils_1.setCypressElement)((0, utils_1.getCypressElement)().first((0, utils_1.getOptions)(options)));
}
(0, cypress_cucumber_preprocessor_1.When)('I get first element', When_I_get_first_element);
