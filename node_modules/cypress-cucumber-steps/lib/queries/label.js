 ...
 */
function When_I_find_elements_by_label_text(text, options) {
    (0, utils_1.setCypressElement)((0, utils_1.getLabelElements)(text, constants_1.PseudoSelector.visible, options));
}
(0, cypress_cucumber_preprocessor_1.When)('I find elements by label text {string}', When_I_find_elements_by_label_text);
/**
 ...
 */
function When_I_find_element_by_label_text(text, options) {
    (0, utils_1.setCypressElement)((0, utils_1.getLabelElements)(text, constants_1.PseudoSelector.visible, options).first());
}
(0, cypress_cucumber_preprocessor_1.When)('I find element by label text {string}', When_I_find_element_by_label_text);
