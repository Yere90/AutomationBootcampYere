 ...
 */
function When_I_get_nth_element(position) {
    var cypressElement = (0, utils_1.getCypressElement)();
    var index = position > 0 ? position - 1 : position;
    (0, utils_1.setCypressElement)(cypressElement.eq(index));
}
(0, cypress_cucumber_preprocessor_1.When)('I get {int}st element', When_I_get_nth_element);
(0, cypress_cucumber_preprocessor_1.When)('I get {int}nd element', When_I_get_nth_element);
(0, cypress_cucumber_preprocessor_1.When)('I get {int}rd element', When_I_get_nth_element);
(0, cypress_cucumber_preprocessor_1.When)('I get {int}th element', When_I_get_nth_element);
