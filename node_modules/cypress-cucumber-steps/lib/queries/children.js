...
exports.When_I_get_children = When_I_get_children;
...
function When_I_get_children() {
    (0, utils_1.setCypressElement)((0, utils_1.getCypressElement)().children());
}
(0, cypress_cucumber_preprocessor_1.When)('I get children', When_I_get_children);
