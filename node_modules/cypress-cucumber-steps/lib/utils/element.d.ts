 ...
 * @private
 */
export declare function setCypressElement(element: CypressChainableElement): CypressChainableElement;
/**
 * Get Cypress element:
 *
 * ```ts
 ...
 * @private
 */
export declare function getCypressElement(): CypressChainableElement;
