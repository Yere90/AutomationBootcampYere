 ...
 */
export declare function Then_I_see_button(text: string, options?: DataTable): void;
/**
 ...
 */
export declare function Then_I_do_not_see_button(text: string, options?: DataTable): void;
