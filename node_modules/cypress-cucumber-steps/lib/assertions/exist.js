 ...
 */
function Then_I_see_element_exists(options) {
    (0, utils_1.getCypressElement)().should('exist', (0, utils_1.getOptions)(options));
}
(0, cypress_cucumber_preprocessor_1.Then)('I see element exists', Then_I_see_element_exists);
/**
 ...
 */
function Then_I_see_element_does_not_exist(options) {
    (0, utils_1.getCypressElement)().should('not.exist', (0, utils_1.getOptions)(options));
}
(0, cypress_cucumber_preprocessor_1.Then)('I see element does not exist', Then_I_see_element_does_not_exist);
