 ...
 */
function Then_I_see_button(text, options) {
    (0, utils_1.getButtonElements)(text, constants_1.PseudoSelector.visible, options).should('exist');
}
(0, cypress_cucumber_preprocessor_1.Then)('I see button {string}', Then_I_see_button);
/**
 ...
 */
function Then_I_do_not_see_button(text, options) {
    (0, utils_1.getButtonElements)(text, constants_1.PseudoSelector.visible, options).should('not.exist');
}
(0, cypress_cucumber_preprocessor_1.Then)('I do not see button {string}', Then_I_do_not_see_button);
