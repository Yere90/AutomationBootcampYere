 ...
 */
function Then_I_see_element_is_visible(options) {
    (0, utils_1.getCypressElement)().should('be.visible', (0, utils_1.getOptions)(options));
}
(0, cypress_cucumber_preprocessor_1.Then)('I see element is visible', Then_I_see_element_is_visible);
/**
 ...
 */
function Then_I_see_element_is_not_visible(options) {
    (0, utils_1.getCypressElement)().should('not.be.visible', (0, utils_1.getOptions)(options));
}
(0, cypress_cucumber_preprocessor_1.Then)('I see element is not visible', Then_I_see_element_is_not_visible);
