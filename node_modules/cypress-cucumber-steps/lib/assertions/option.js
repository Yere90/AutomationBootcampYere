 ...
 * ```
 */
function Then_I_see_option(text) {
    cy.contains('option:visible', text).should('exist');
}
(0, cypress_cucumber_preprocessor_1.Then)('I see option {string}', Then_I_see_option);
/**
 ...
 * ```
 */
function Then_I_do_not_see_option(text) {
    cy.contains('option:visible', text).should('not.exist');
}
(0, cypress_cucumber_preprocessor_1.Then)('I do not see option {string}', Then_I_do_not_see_option);
