 ...
 */
function Then_I_see_text(text, options) {
    cy.contains(text, (0, utils_1.getOptions)(options)).filter(':visible').should('exist');
}
(0, cypress_cucumber_preprocessor_1.Then)('I see text {string}', Then_I_see_text);
/**
 ...
 */
function Then_I_do_not_see_text(text, options) {
    cy.contains(text, (0, utils_1.getOptions)(options)).should('not.exist');
}
(0, cypress_cucumber_preprocessor_1.Then)('I do not see text {string}', Then_I_do_not_see_text);
/**
 ...
 */
function Then_I_do_not_see_visible_text(text, options) {
    cy.contains(text, (0, utils_1.getOptions)(options)).should('not.be.visible');
}
(0, cypress_cucumber_preprocessor_1.Then)('I do not see visible text {string}', Then_I_do_not_see_visible_text);
