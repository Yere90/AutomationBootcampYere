...
exports.Then_I_see_role = Then_I_see_role;
exports.Then_I_do_not_see_role = Then_I_do_not_see_role;
 ...
 */
function Then_I_see_role(role, options) {
    (0, utils_1.getRoleElements)(role, constants_1.PseudoSelector.visible, options).should('exist');
}
(0, cypress_cucumber_preprocessor_1.Then)('I see role {string}', Then_I_see_role);
/**
 ...
 */
function Then_I_do_not_see_role(role, options) {
    (0, utils_1.getRoleElements)(role, constants_1.PseudoSelector.visible, options).should('not.exist');
}
(0, cypress_cucumber_preprocessor_1.Then)('I do not see role {string}', Then_I_do_not_see_role);
